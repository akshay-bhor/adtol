...
import { editCampaignAction, fetchCampaignData, fetchCampaignTypes } from "../../../store/actions/campaigns.action";
...
const EditCampaign = () => {
  ...
  const type = router.query.type; // campaign or pop
  const campaign_id = router.query.campid;
  ...
  const onSubmit = (values) => {
    ...
    dispatch(editCampaignAction(postData));
  }
