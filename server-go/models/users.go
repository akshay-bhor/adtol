...
type Users struct {
	...
	Mobile       string  `gorm:"not null:true;size:12;index:,type:btree" json:"mobile"`
	Name         *string `gorm:"not null:false;size:20" json:"name"`
	Surname      *string `gorm:"not null:false;size:20" json:"surname"`
