...
const CampaignsSchema = new Schema({
    ...
    campaign_type: { type: Schema.Types.ObjectId, ref: 'Campaign_types', required: true, default: 0},
    uid: {type: Schema.Types.ObjectId, ref: 'User', required: true},
    title: String,
    desc: String,
    url: { type: String, required: true},
    domain_hash: { type: String, required: true},
    category: { type: String, required: true, default: 0},
    country: { type: String, required: true, default: 0},
    device: { type: String, required: true, default: 0},
    os: { type: String, required: true, default: 0},
    browser: { type: String, required: true, default: 0},
    language: { type: String, required: true, default: 0},
    day: { type: String, required: true, default: 0},
    timezone: { type: String, required: true, default: 'Asia/Kolkata'},
    rel: { type: Number, required: true, default: 1},
    btn: { type: Number, required: true, default: 0},
    bot: { type: Number, required: true, default: 0},
    cpc: { type: Number, required: true, default: 0.02},
    views: { type: Number, required: true, default: 0},
    clicks: { type: Number, required: true, default: 0},
    pops: { type: Number, required: true, default: 0},
    budget: { type: Number, required: true},
    budget_rem: { type: Number, required: true},
    today_budget: { type: Number, required: true},
    today_budget_rem: { type: Number, required: true},
    spent: { type: Number, required: true},
    adult: { type: Number, required: true, default: 0},
    run: { type: Number, required: true, default: 1},
    status: { type: Number, required: true, default: 2},
    pro: { type: Number, required: true, default: 0},
