...
//
// const Clicks = mongoose.model('clicks', new Schema({
//     campaign_id: {
...
//         default: 1
//     }
// }).index({ category: 1, device: 1, os: 1, browser: 1, country: 1, language: 1, adult: 1 }));
//
...
const ClicksSchema = new Schema({
    ...
    ad_uid: { type: Number, required: true},
    pub_uid: { type: Number, required: true},
    campaign_id: { type: Number, required: true},
    ad_id: { type: Number, required: true},
    site_id: { type: Number, required: true},
    ad_url: { type: String, required: true},
    ad_url_tiny: { type: String, required: true},
    pub_url: { type: String, required: true},
    pub_url_tiny: { type: String, required: true},
    ad_type: { type: Number, required: true},
    category: { type: Number, required: true, default: 0},
    device: { type: Number, required: true, default: 0},
    os: { type: Number, required: true, default: 0},
    browser: { type: Number, required: true, default: 0},
    ...
    ip_tiny: { type: String, required: true},
    ad_cpc: { type: Number, required: true},
    pub_cpc: { type: Number, required: true},
    day_unix: { type: Number, required: true, default: 0},
    time_unix: { type: Number, required: true, default: 0},
    valid: { type: Number, required: true, default: 1}
});
