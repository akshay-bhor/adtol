...
exports.getAdcodeHelper = async (req) => {
    ...
    try {
        ...
        bInfo.forEach(b => {
            ...
            <script id="${randId}" type="text/javascript" src="https://${req.get('host')}/js/ads/banner.js" async defer></script>`;
        });
        ...
        <script id="${randId}" type="text/javascript" src="https://${req.get('host')}/js/ads/text.js" async defer></script>`;
        ...
        <script id="${randId}" type="text/javascript" src="https://${req.get('host')}/js/ads/native.js" async defer></script>`;
        ...
        <script id="${randId}" type="text/javascript" src="https://${req.get('host')}/js/ads/pop.js" async defer></script>`;
        ...
        <script id="${randId}" type="text/javascript" src="https://${req.get('host')}/js/ads/feed.js" async defer></script>`;
