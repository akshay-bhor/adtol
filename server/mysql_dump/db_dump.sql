...
CREATE TABLE `campaigns` (
  ...
  `country` varchar(1000) NOT NULL DEFAULT '0',
  `device` varchar(10) NOT NULL DEFAULT '0',
  `os` varchar(240) NOT NULL DEFAULT '0',
  `browser` varchar(60) NOT NULL DEFAULT '0',
  `language` varchar(75) NOT NULL DEFAULT '0',
...
CREATE TABLE `settings` (
  ...
  `min_pop_cpc` float(10,5) NOT NULL DEFAULT '0.00200',
...
INSERT INTO `settings` VALUES (1,1.00,5000.00,100.00,2.00,10.00,0.00100,0.00010,1.00000,1.00000);
...
INSERT INTO `user_info` VALUES (1,1000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2021-10-17 11:56:41','2021-10-17 11:56:41');
